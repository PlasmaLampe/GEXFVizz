...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="impressum.php">Contact</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
    ...
    <div class="container">
		...
		<p>Joerg Amelunxen<br />
		Rosenmuehlenweg 22<br />
		33014 Bad Driburg<br />
		<br>
		</p>
		<tr><td><p>E-Mail:</p></td>
		<td><p>j.amelunxen (at) web.de</p></td>
		</tr></table>
		<p> </p>
		...
		<p><i>Quellen: <a href="http://www.e-recht24.de/muster-disclaimer.htm" target="_blank">Disclaimer</a> von eRecht24, dem Portal zum Internetrecht von Rechtsanwalt Sören Siebert</i></p>
